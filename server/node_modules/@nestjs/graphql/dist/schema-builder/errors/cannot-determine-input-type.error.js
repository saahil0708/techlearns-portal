export class CannotDetermineInputTypeError extends Error {
    constructor(hostType, typeRef, isRegisteredAsObjectType) {
        ...
        super(`Cannot determine a GraphQL input type${inputObjectName ? ` ("${inputObjectName}")` : ''} for the "${hostType}". Make sure your class is decorated with an appropriate decorator.`);
    }
}
