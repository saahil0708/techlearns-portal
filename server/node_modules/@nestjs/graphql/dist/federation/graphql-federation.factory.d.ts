...
import { AutoSchemaFileValue, BuildFederatedSchemaOptions, GqlModuleOptions } from '../interfaces/index.js';
...
export declare class GraphQLFederationFactory {
    ...
    private loadApolloSubgraph;
    private getFederationSchemaPrinter;
