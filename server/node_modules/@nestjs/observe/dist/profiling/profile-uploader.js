    ...
    async send(window, sampleRateHz) {
        ...
        try {
            ...
            if (response.status === 429) {
                ...
                this.options.onError?.(`profile upload rate-limited (429) - the account may be out of credits or over budget; ` +
