...
export declare class BatchesResolver {
    private batchesService;
    constructor(batchesService: BatchesService);
    private checkInstitutionBatchAccess;
    private checkBatchAccess;
    getBatches(user: CurrentUserPayload, pagination: PaginationArgs, institutionId?: string, collegeId?: string): Promise<{
        items: ({
            institution: {
                id: string;
                name: string;
    ...
    getBatch(user: CurrentUserPayload, id: string): Promise<{
        institution: {
            id: string;
            name: string;
            code: string;
    ...
    getBatchStudents(user: CurrentUserPayload, batchId: string, pagination: PaginationArgs): Promise<{
        items: ({
            user: {
                id: string;
                email: string;
    ...
    createBatch(user: CurrentUserPayload, input: CreateBatchInput): Promise<{
        institution: {
            id: string;
            name: string;
            code: string;
    ...
    updateBatch(user: CurrentUserPayload, id: string, input: UpdateBatchInput): Promise<{
        institution: {
            id: string;
            name: string;
            code: string;
    ...
    deleteBatch(user: CurrentUserPayload, id: string): Promise<{
        id: string;
        name: string;
        institutionId: string;
        status: string;
    ...
    assignStudentsToBatch(user: CurrentUserPayload, input: AssignStudentsInput): Promise<({
        user: {
            id: string;
            email: string;
            name: string;
    ...
    removeStudentFromBatch(user: CurrentUserPayload, batchId: string, userId: string): Promise<{
        id: string;
        batchId: string;
        rollNo: string | null;
        userId: string;
