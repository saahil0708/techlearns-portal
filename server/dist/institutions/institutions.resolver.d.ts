...
export declare class InstitutionsResolver {
    ...
    private checkInstitutionUpdateAccess;
    private checkInstitutionMemberAccess;
    getInstitutions(paginationArgs: PaginationArgs, status?: InstitutionStatus): Promise<{
        items: ({
            memberships: {
    ...
    getInstitution(id: string, currentUser: CurrentUserPayload): Promise<{
        pendingInvitations: ({
            delivery: {
                status: string;
            } | null;
    ...
    createInstitution(input: CreateInstitutionInput): Promise<{
        memberships: {
            role: import("@prisma/client").$Enums.Role;
        }[];
        _count: {
    ...
    updateInstitution(id: string, input: UpdateInstitutionInput, currentUser: CurrentUserPayload): Promise<{
        _count: {
            memberships: number;
            batches: number;
            courses: number;
    ...
    addInstitutionMember(institutionId: string, input: AddInstitutionMemberInput, currentUser: CurrentUserPayload): Promise<boolean>;
    removeInstitutionMember(institutionId: string, userId: string, currentUser: CurrentUserPayload): Promise<boolean>;
}
