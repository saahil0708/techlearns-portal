...
export declare class InstitutionsController {
    ...
    delete(id: string, purgeUsers?: string): Promise<boolean>;
    addMember(id: string, dto: AddMemberDto, user: CurrentUserPayload): Promise<{
        user: {
            id: string;
            email: string;
            name: string;
    ...
    removeMember(id: string, userId: string, user: CurrentUserPayload): Promise<boolean>;
}
