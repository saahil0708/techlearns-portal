...
import { EvaluateSubmissionJobData } from '../judge/judge.constants.js';
...
export declare class SubmissionsService {
    ...
    constructor(prisma: PrismaService, submissionQueue?: Queue<EvaluateSubmissionJobData> | undefined);
    create(input: CreateSubmissionInput, userId: string, user?: CurrentUserPayload): Promise<{
        user: {
            id: string;
            email: string;
            name: string;
    ...
    findPaginated(args: PaginationArgs, problemId?: string, userId?: string, contestId?: string, verdict?: SubmissionVerdict, language?: ProgrammingLanguage): Promise<{
        items: ({
            user: {
                id: string;
                email: string;
