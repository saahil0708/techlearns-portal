...
export declare class ContestsService {
    ...
    create(input: CreateContestInput, creatorId: string, user?: CurrentUserPayload): Promise<{
        _count: {
            submissions: number;
            problems: number;
    ...
    findPaginated(args: PaginationArgs, status?: ContestStatus, institutionId?: string, user?: CurrentUserPayload): Promise<{
        items: ({
            _count: {
                submissions: number;
                problems: number;
    ...
    update(id: string, input: UpdateContestInput, user?: CurrentUserPayload): Promise<{
        _count: {
            submissions: number;
            problems: number;
            registrations: number;
    ...
    registerUser(contestId: string, userId: string, user?: CurrentUserPayload): Promise<{
        user: {
            id: string;
            email: string;
            name: string;
    ...
    addProblem(contestId: string, input: AddContestProblemInput, user?: CurrentUserPayload): Promise<{
        problem: {
            id: string;
            title: string;
            institutionId: string | null;
