...
export declare class ContestsResolver {
    private contestsService;
    constructor(contestsService: ContestsService);
    getContests(paginationArgs: PaginationArgs, status?: ContestStatus, institutionId?: string, collegeId?: string, currentUser?: CurrentUserPayload): Promise<{
        items: ({
            _count: {
                submissions: number;
                problems: number;
    ...
    getContest(id: string, currentUser?: CurrentUserPayload): Promise<{
        _count: {
            submissions: number;
            problems: number;
            registrations: number;
    ...
    createContest(input: CreateContestInput, currentUser: CurrentUserPayload): Promise<{
        _count: {
            submissions: number;
            problems: number;
            registrations: number;
    ...
    updateContest(id: string, input: UpdateContestInput, currentUser: CurrentUserPayload): Promise<{
        _count: {
            submissions: number;
            problems: number;
            registrations: number;
    ...
    deleteContest(id: string, currentUser: CurrentUserPayload): Promise<boolean>;
    registerForContest(contestId: string, currentUser: CurrentUserPayload): Promise<{
        user: {
            id: string;
            email: string;
            name: string;
    ...
    addContestProblem(contestId: string, input: AddContestProblemInput, currentUser: CurrentUserPayload): Promise<{
        problem: {
            id: string;
            title: string;
            institutionId: string | null;
