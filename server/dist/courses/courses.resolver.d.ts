...
export declare class CoursesResolver {
    ...
    getCourses(paginationArgs: PaginationArgs, institutionId?: string, collegeId?: string, status?: CourseStatus, currentUser?: CurrentUserPayload): Promise<{
        items: ({
            _count: {
                enrollments: number;
                modules: number;
    ...
    getCourse(id: string, currentUser?: CurrentUserPayload): Promise<{
        institution: {
            id: string;
            name: string;
            code: string;
    ...
    createCourse(input: CreateCourseInput, currentUser: CurrentUserPayload): Promise<{
        createdBy: {
            id: string;
            email: string;
            name: string;
    ...
    updateCourse(id: string, input: UpdateCourseInput, currentUser: CurrentUserPayload): Promise<{
        description: string | null;
        id: string;
        title: string;
        institutionId: string | null;
    ...
    deleteCourse(id: string, currentUser: CurrentUserPayload): Promise<boolean>;
}
