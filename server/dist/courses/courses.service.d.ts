...
export declare class CoursesService {
    ...
    createCourse(userId: string, dto: CreateCourseDto, user?: CurrentUserPayload): Promise<{
        createdBy: {
            id: string;
            email: string;
            name: string;
    ...
    findAll(institutionId?: string, status?: CourseStatus, user?: CurrentUserPayload): Promise<({
        _count: {
            enrollments: number;
            modules: number;
        };
    ...
    findPaginated(args: {
        ...
        sortBy?: string;
        sortOrder?: string;
    }, institutionId?: string, status?: CourseStatus, user?: CurrentUserPayload): Promise<{
        items: ({
            _count: {
                enrollments: number;
                modules: number;
    ...
    findCourseById(id: string, user?: CurrentUserPayload): Promise<{
        institution: {
            id: string;
            name: string;
            code: string;
    ...
    updateCourse(id: string, dto: UpdateCourseDto, user: CurrentUserPayload): Promise<{
        description: string | null;
        id: string;
        title: string;
        institutionId: string | null;
    ...
    deleteCourse(id: string, user: CurrentUserPayload): Promise<{
        description: string | null;
        id: string;
        title: string;
        institutionId: string | null;
    ...
    enrollStudent(courseId: string, user: CurrentUserPayload): Promise<{
        course: {
            description: string | null;
            id: string;
            title: string;
    ...
    updateLessonProgress(lessonId: string, userId: string, completed: boolean): Promise<{
        id: string;
        userId: string;
        completedAt: Date | null;
        lessonId: string;
    ...
    private assertCourseAuthorOrAdmin;
