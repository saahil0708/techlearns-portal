...
const SEED_STUDENTS: Record<string, Partial<StudentProfileData>> = {
  'mayalin_cs': {
    ...
    role: 'STUDENT',
    bio: 'Competitive programmer & USACO Gold contender. Focused on graph algorithms, segment trees, and dynamic programming optimization.',
    institution: 'Stuyvesant High School of Science',
