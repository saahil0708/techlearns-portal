...
const SEED_STUDENTS: Record<string, Partial<StudentProfileData>> = {
  ...
  'liam_vance': {
    ...
    name: 'Liam Vance',
    handle: 'liam_vance',
    email: 'l.vance@iitd.ac.in',
    role: 'STUDENT',
    bio: 'CS undergraduate at IIT Delhi. Passionate about concurrent distributed systems, memory models, and algorithmic game theory.',
    institution: 'IIT Delhi - Dept of Computer Science',
  ...
  'alex_mercer': {
    ...
    name: 'Alex Mercer',
    handle: 'alex_mercer',
    email: 'alex.m@iiit.ac.in',
    role: 'STUDENT',
    bio: 'CSE undergraduate at IIIT Hyderabad. Building high-performance systems and competing in ICPC Div 1.',
    institution: 'IIIT Hyderabad - Dept of CSE',
