...
export const MOCK_PROBLEMS: ProblemEntity[] = [
  {
    ...
    subtasks: [
      { name: 'Subtask 1 (N <= 100)', points: 30, testCases: 15 },
      { name: 'Subtask 2 (Full Constraints)', points: 70, testCases: 40 },
    ],
    timeLimitMs: 1000,
    memoryLimitMb: 256,
    likes: 12450,
...
`,
  ...
  },
  {
    ...
    contestCode: 'START185',
    subtasks: [
      { name: 'Subtask 1 (N <= 500)', points: 40, testCases: 18 },
      { name: 'Subtask 2 (Full Constraints)', points: 60, testCases: 30 },
    ],
    timeLimitMs: 1000,
    memoryLimitMb: 256,
    likes: 9840,
