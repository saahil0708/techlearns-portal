    ...
    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1fr 1fr' }, gap: 3 }}>
      ...
      >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 1.5, borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>
            <Box>
              <Typography sx={{ fontWeight: 700, color: '#F8FAFC', fontSize: '0.9rem' }}>Two-Factor Authentication (2FA)</Typography>
              <Typography variant="caption" sx={{ color: '#94A3B8' }}>Time-based TOTP authenticator protection</Typography>
            </Box>
            <Chip
              label={twoFactorEnabled ? 'Active • Protected' : 'Not enabled'}
              size="small"
              sx={{
                bgcolor: twoFactorEnabled ? 'rgba(16, 185, 129, 0.2)' : 'rgba(30, 41, 59, 0.8)',
                color: twoFactorEnabled ? '#34D399' : '#94A3B8',
                fontWeight: 700,
                border: twoFactorEnabled ? '1px solid rgba(16, 185, 129, 0.4)' : '1px solid rgba(255, 255, 255, 0.1)',
              }}
            />
          </Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 1.5, borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>
            <Box>
              <Typography sx={{ fontWeight: 700, color: '#F8FAFC', fontSize: '0.9rem' }}>Account Password</Typography>
              <Typography variant="caption" sx={{ color: '#94A3B8' }}>High-security bcrypt hashing (12 rounds)</Typography>
            </Box>
            <Button
              variant="outlined"
              size="small"
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
          ...
          <Chip label="Coming Soon" size="small" sx={{ bgcolor: 'rgba(30, 41, 59, 0.8)', color: '#94A3B8', fontWeight: 600, fontSize: '0.72rem', border: '1px solid rgba(255, 255, 255, 0.08)' }} />
        </Box>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mt: 1 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 1.5, borderRadius: '10px', bgcolor: 'rgba(30, 41, 59, 0.8)', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
              <Typography sx={{ fontSize: '0.85rem', fontWeight: 600, color: '#E2E8F0' }}>Contest Reminders & Starts</Typography>
              <Button
                size="small"
                disabled
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 1.5, borderRadius: '10px', bgcolor: 'rgba(30, 41, 59, 0.8)', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
              <Typography sx={{ fontSize: '0.85rem', fontWeight: 600, color: '#E2E8F0' }}>Course & Lesson Milestone Alerts</Typography>
              <Button
                size="small"
                disabled
      ...
      >
        <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', pb: 1 }}>
          ...
          <IconButton size="small" onClick={() => setPasswordModalOpen(false)} sx={{ color: '#94A3B8', '&:hover': { color: '#FFFFFF' } }}>
        ...
        <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2.5, px: 3.5, pt: '28px !important', pb: 3 }}>
          {passwordError && (
            <Alert severity="error" sx={{ borderRadius: '12px', fontSize: '0.82rem', bgcolor: 'rgba(239, 68, 68, 0.15)', color: '#FCA5A5', border: '1px solid rgba(239, 68, 68, 0.3)' }}>
              {passwordError}
            </Alert>
          )}
          ...
          {/* Current Password */}
          <Box>
            <Typography variant="caption" sx={{ fontWeight: 700, color: '#E2E8F0', mb: 0.5, display: 'block' }}>
              Current Password
            </Typography>
            <TextField
              fullWidth
                ...
                input: {
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton size="small" onClick={() => setShowCurrentPassword(!showCurrentPassword)} edge="end" sx={{ color: '#94A3B8' }}>
            ...
            <TextField
              ...
              slotProps={{
                input: {
                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton size="small" onClick={() => setShowNewPassword(!showNewPassword)} edge="end" sx={{ color: '#94A3B8' }}>
          ...
          <Box>
            ...
            {confirmPassword && newPassword === confirmPassword && (
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 0.5 }}>
                ...
                <Typography variant="caption" sx={{ color: '#34D399', fontWeight: 600, fontSize: '0.74rem' }}>
                  Passwords match
                </Typography>
              </Box>
            )}
