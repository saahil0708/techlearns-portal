    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          {/* Star Rating Badge - CodeChef Style */}
          {typeof contestRating === 'number' && (
            <Box sx={{ display: { xs: 'none', sm: 'inline-flex' } }}>
              <StarRatingBadge rating={contestRating} size="small" showDivision={true} />
            </Box>
          )}
      ...
      >
        ...
        <MenuItem
          ...
          sx={{ fontSize: '0.82rem', py: 1, gap: 1.25, color: '#334155', '&:hover': { bgcolor: '#F8FAFC' } }}
        >
        ...
        <MenuItem
          ...
          sx={{ fontSize: '0.82rem', py: 1, color: '#DC2626', gap: 1.25, '&:hover': { bgcolor: '#FEF2F2' } }}
        >
